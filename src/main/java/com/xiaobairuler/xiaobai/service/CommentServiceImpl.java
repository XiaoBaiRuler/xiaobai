...
import com.xiaobairuler.xiaobai.dao.CommentRepository;
...
public class CommentServiceImpl implements CommentService {
    ...
    public Comment saveComment(Comment comment) {
        ...
        if (parentCommentId != -1) {
            comment.setParentComment(commentRepository.findByParentCommentId(parentCommentId));
        } else {
